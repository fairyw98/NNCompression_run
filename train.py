...
def main(args):
    ...
    model = create_model(num_classes=args.num_classes,partition_id=args.partition_id,quant_bits=args.quant_bits,coder_channels=args.coder_channels,en_stride = args.en_stride).to(device)
    if args.weights != "":
...
if __name__ == '__main__':
    ...
    parser.add_argument('--coder_channels', type=int, default=8)
    parser.add_argument('--en_stride', type=int, default=7)
